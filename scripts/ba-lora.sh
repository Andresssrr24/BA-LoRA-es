...
python utils/gen_vllm.py --model $OUTPUT_PATH --data_path /root/autodl-tmp/models/pissa-dataset --sub_task metamath --output_file $OUTPUT_PATH/metamath_response.jsonl
